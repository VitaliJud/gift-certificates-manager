# Gift Certificates Manager and Exporter
This is a Gift Certificates Manager app built with the [BigCommerce NextJS Sample App](https://github.com/bigcommerce/sample-app-nodejs). This app enables users to view, manage, bulk generate, and bulk export Codes and see history of the orders they were used for [Gift Certificates](https://support.bigcommerce.com/s/article/Gift-Certificates).
